...
const AddFoodTypePage = () => {
  ...
  const handleSave = async () => {
    try {
      const response = await axios.post("http://127.0.0.1:8000/food-types/", {
        name,
      });
        ...
        <div className="p-8 flex-grow login-signup-container">
          <div className="login-form-container">
            <div className="add-restaurant-card">
              <h2 className="mb-6 block">Add New Food Type</h2>
...
export default AddFoodTypePage;
