...
const FoodTypes = () => {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://127.0.0.1:8000/food-types/${id}`);
      fetchFoodTypes();
    } catch (error) {
  ...
  const handleAddNew = () => {
    navigate("/add-food-type");
  };

  const handleEdit = (id) => {
    navigate(`/edit-food-type/${id}`);
  };
  ...
  const currentItems = foodTypes.slice(indexOfFirstItem, indexOfLastItem);
            ...
            <div className="overflow-x-auto mt-8">
                      ...
                      <Table.Cell>
                        <div className="flex justify-end space-x-2">
                          <Button
                            ...
                            onClick={() => handleEdit(foodType.id)}
                          >
                            Edit
                          </Button>
                          <Button
              ...
              <div className="flex justify-center mt-4">
                <Pagination
                  ...
                  totalPages={Math.ceil(foodTypes.length / itemsPerPage)}
