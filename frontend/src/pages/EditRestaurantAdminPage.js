...
const EditRestaurantAdminPage = () => {
  ...
  const fetchAdminDetails = async () => {
    try {
      ...
      setSelectedRestaurant(admin.restaurant_id || "");
    } catch (error) {
  ...
  const handleUpdate = async () => {
    try {
      await axios.put(
        `http://127.0.0.1:8000/admin/update-restaurant-admin/${id}`,
        {
          name,
          email,
      ...
      setSuccessMessage("Restaurant admin updated successfully!");
      setTimeout(() => {
      ...
      <Navbar fluid className="bg-transparent shadow-lg">
        <Navbar.Brand href="/admin-dashboard">
          ...
          <span className="self-center whitespace-nowrap text-xl font-semibold text-white">
            Admin Dashboard - Edit Restaurant Admin
          </span>
        </Navbar.Brand>
        ...
        <div className="p-8 flex-grow login-signup-container">
          <div className="login-form-container">
            <div className="add-restaurant-card">
              <h2 className="mb-6 block">Edit Restaurant Admin</h2>
...
export default EditRestaurantAdminPage;
